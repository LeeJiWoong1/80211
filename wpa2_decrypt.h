...
struct ieee80211_llc_header
{
    ...
    u_int8_t oui[3];
    u_int16_t ethertype;
#define IEEE80211_LLC_ETHERTYPE_IP 0x0008
#define IEEE80211_LLC_ETHERTYPE_AUTH 0x8e88
}__attribute__ ((packed));

struct wpa2_ccmp { u_int8_t ccmp[8]; } __attribute__ ((packed));
...
class CAnalyze 
{
    ...
    private:
        ...
        uint8_t ap_addr[IEEE80211_ADDR_LEN] = { 0x70, 0x5d, 0xcc, 0x4b, 0x29, 0xee };
        uint8_t dev_addr[IEEE80211_ADDR_LEN] = { 0xc0, 0xa6, 0x00, 0xc4, 0x81, 0x41 };
        string ssid;
        string pass;
    ...
    protected:
        ...
        bool is_equal(uint8_t _c1[], uint8_t _c2[], int _len);
};
